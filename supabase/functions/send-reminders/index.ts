  ...
  try {
    ...
    for (const employee of employees as Employee[]) {
      ...
      if (
        ...
        isExpiringSoon(employee.passport_expiry, thirtyDaysStr)
      ) {
      ...
      if (
        ...
        isExpiringSoon(employee.card_expiry, thirtyDaysStr)
      ) {
        expiringDocuments.push({
          type: "card",
      ...
      if (
        ...
        isExpiringSoon(employee.emirates_id_expiry, thirtyDaysStr)
      ) {
        expiringDocuments.push({
          type: "emirates_id",
      ...
      if (
        ...
        isExpiringSoon(employee.residence_expiry, thirtyDaysStr)
      ) {
        expiringDocuments.push({
          type: "residence",
      ...
      for (const doc of expiringDocuments) {
        try {
          ...
          console.error(
            `Error processing ${doc.type} for ${employee.name_en}:`,
            err
          );
          results.push({
            employee: employee.name_en,
    ...
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        html: `
          ...
          <p>This is a reminder that your <strong>${docType.replace(
            "_",
            " "
